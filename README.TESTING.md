# Testing Guide - DeX Trading Agent

## Overview

This project includes comprehensive unit tests for both frontend (TypeScript/Vitest) and backend (Python/pytest) components, with a focus on:
