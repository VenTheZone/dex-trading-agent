...
import { getMarginTier, calculateLiquidationPrice, calculateMaintenanceMargin, calculateInitialMargin, assessLiquidationRisk, canOpenPosition, getAssetMaxLeverage, validateLeverage, } from '../liquidation-protection';
...
describe('Liquidation Protection - Liquidation Price Calculation', () => {
    it('should calculate liquidation price for long position correctly', () => {
        ...
        const liqPrice = calculateLiquidationPrice(entryPrice, positionSize, 'long', marginAvailable);
    ...
    it('should calculate liquidation price for short position correctly', () => {
        ...
        const positionSize = 1;
        const marginAvailable = 10000;
        const liqPrice = calculateLiquidationPrice(entryPrice, positionSize, 'short', marginAvailable);
