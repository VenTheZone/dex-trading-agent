...
export function TradeConfirmationModal({ isOpen, onClose, onConfirm, tradeDetails }) {
    ...
    return (<Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-black/95 border-cyan-500/50 text-cyan-100 max-w-md">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4 py-4">
          {/* Mode Warning */}
          {isLive && (<div className="bg-red-500/10 border border-red-500/50 rounded-lg p-3">
          ...
          <div className="space-y-3 bg-black/50 border border-cyan-500/30 rounded-lg p-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant={tradeDetails.side === 'long' ? 'default' : 'destructive'} className="font-mono">
                {tradeDetails.side === 'long' ? (<TrendingUp className="h-3 w-3 mr-1"/>) : (<TrendingDown className="h-3 w-3 mr-1"/>)}
            ...
            {tradeDetails.stopLoss && (<div className="flex items-center justify-between">
            ...
            {tradeDetails.takeProfit && (<div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className={tradeDetails.network === 'mainnet'
        ...
        <DialogFooter className="gap-2">
          <Button variant="outline" onClick={onClose} className="border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/20 font-mono">
            Cancel
          </Button>
          <Button onClick={onConfirm} className={`font-mono font-bold ${isLive
